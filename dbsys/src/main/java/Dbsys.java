...
public class Dbsys {
    ...
    static String land = "";
    static String startDatum = "";
    static String endDatum = "";
    static String ausstattung = "";
    static String email = "";
    ...
    private static void connectToSqlServer() {
        ...
        try {
            ...
            System.out.println("Press s: to search, b: to book or e: to exit");
            while (true) {
                switch (in.readLine()) {
                    ...
                    case "s": {
                        ...
                        System.out.println(" Please enter start date in format dd.mm.yyyy - \n");
                        startDatum = in.readLine();

                        System.out.println(" Please enter end date in format dd.mm.yyyy - \n");
                    ...
                    default: {
                        ...
                        System.out.println("Please select a search, book or exit function");
                    }
...
*/
    ...
    private static String queryForFerienWohnung(String startDatum, String endDatum, String austtatung, String land) {
        ...
        if (!startDatum.isEmpty() && !endDatum.isEmpty() && !land.isEmpty() && !austtatung.isEmpty()) {

           return "SELECT f.name \n" +
                    "FROM DBSYS51.ferienwohnung f left outer join DBSYS51.buchung b on f.name = b.ferienwohnungsname, DBSYS51.adresse a \n" +
                    "WHERE\n" +
                    "    NOT EXISTS( \n" +
        ...
        } else if (!startDatum.isEmpty() && !endDatum.isEmpty() && !land.isEmpty()) {
